...
// setting Date and Hour format for current time and linking it to #currentDay
...
// intiate the app upon start up. loads saved data from local storage
...
//  changing color of text box base on time by adding class name; 
